 ...
 * @constructor
 */
function SessionToken({expireTime, redisKeyPrefix, redis, subRedis,crontabStr,maxSize,clusteId,subscribeCallback,cacheWriteCallback,cacheClearCallback,showMemSizeInterval,idleCheckInterval,idleCheckPerCount,memLifecycleRatio,wrapperClass}) {
...
SessionToken.prototype._removeCache = function(token, removeAll) {
    if (removeAll) {
        this.data.clear();
    } else {
