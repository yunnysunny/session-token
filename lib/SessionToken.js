 ...
 * @param {Number} [idleCheckPerCount=0] The count of items to check in one loop of the idle checking.
 * @param {Float} memLifecycleRatio The lifecycle of the memeory cache, default is 1.0 , which means that it equals to the lifecycle of redis cache. 
 */
 ...
 * @constructor
 */
function SessionToken({expireTime, redisKeyPrefix, redis, subReis,crontabStr,maxSize,useLru,clusteId,subscribeCallback,cacheWriteCallback,cacheClearCallback,showMemSizeInterval,idleCheckInterval,idleCheckPerCount,memLifecycleRatio}) {
