 ...
 *
 * @param {Object} option
 * @param {Number=0} option.expireTime Expiration time in second, default is 0, which will be not expired, but when you set the paramter of `option.crontabStr`, it will be cleared at some time still.
...
SessionToken.prototype.update = function (token, value, callback) {
    ...
    this.redis.set(keyName, valueStr, 'XX', 'EX', expireTime, function (err) {
