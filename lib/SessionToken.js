 ...
 * @param {Object|undefined} option.subReis The subscribe redis client to receive delete operation form other node.js process, it's useful when you start node in cluster mode.
 * @param {String|undefined} option.crontabStr Crontab string, use for clearing the memeory cache.
